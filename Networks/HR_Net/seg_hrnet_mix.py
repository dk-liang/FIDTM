...
class HighResolutionNet(nn.Module):
    ...
    def __init__(self, config, **kwargs):
        ...
        self.last_layer_reg = nn.Sequential(
            nn.Conv2d(
                in_channels=last_inp_channels,
                out_channels=last_inp_channels,
                kernel_size=1,
...
def get_seg_model(**kwargs):
    ...
    update_config(hr_config, '/home/dkliang/projects/synchronous/rdt_threshold/Networks/HR_Net/seg_hrnet_w48.yaml')
